<template>
    <h1 style="position: absolute;z-index:1;color: white;left: 50%;transform:translate(-50%,0);">你好</h1>
    <button style="position: absolute;z-index:1;left: 50%;top: 12%;transform:translate(-50%,0);" type="button"> 这是一个没有任何用处的按钮 </button>
